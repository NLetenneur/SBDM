 ...
 */
class TBiereRepository extends ServiceEntityRepository
{
    ...
    public function save(Typebiere $entity, bool $flush = false): void
    {
    ...
    public function remove(Typebiere $entity, bool $flush = false): void
    {
